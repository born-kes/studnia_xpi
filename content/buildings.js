...
if (table.innerHTML) table.innerHTML += '<tr><td colspan="3"><form action="http://www.bornkes.w.szu.pl/pl/mur.php" method="POST" target="_blank">'+stor+'<input type="submit" value="&#8595; Do Studni &#8595;" /></form></td></tr>';
