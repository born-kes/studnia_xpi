...
{   if(anchorTags[i].href.indexOf('javascript:')>=0 ){
  // alert("Atrybut href dla " + i + " elementu to: " + anchorTags[i].href + "\n");
       ...
       if(anchorTags[i].href.indexOf('archer_')>=0 ){ luk=luk+';'+ anchorTags[i].href.substring(11);}
...
if (table.innerHTML) table.innerHTML += '<tr><th colspan="3">Rekrutuj Wszystkie Jednostki Jednego Typu:</th><th><a href="'+pik+'">piki</a></th><th><a href="'+mie+'">miecze</a></th><th><a href="'+axe+'">Topory</a></th><th><a href="'+luk+'">Luki</a></th><th><a href="'+zw+'">Zwiadowcy</a></th><th><a href="'+lk+'">Lekka kawaleria</a></th><th><a href="'+lk+'">Luki na koniach</a></th><th><a href="'+ck+'">CK</a></th><th><a href="'+tar+'">Tarany</a></th><th><a href="'+kat+'">Katapulty</a></th></tr>';
