...
(function(){
	...
	var lang = {
		'en': {
			...
			'troupsize': 'Ilosc jednostek',
			'troupsizedesc': 'Model wojska w tej grupie wedlog ktorego bedzie przebiegala rekrutacja.',
			'openend': 'Do oporu:',
			'openenddesc': 'po wyprodykowaniu zleconych bedzie produkcja do wyczerpania miejsca w zagrodzie.',
			'farmfree': 'Pozostawic miejsca w zagrodzie:',
			'farmfreedesc': 'Ile ma zostac wolnego miejsca w zagrodzie (np. 100 na Ulunga ;).',
			'resfree': 'Pozostawic surowcow:',
			'resfreedesc': 'Ile ma zostac surowcow.',
			'save': 'Zapisz',
			'fill': 'Wprowadz',
			'recruit': 'Rekrutuj',
			'running': 'czekaj...',
