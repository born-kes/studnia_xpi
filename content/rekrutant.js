...
(function(){
	...
	var lang = {
		'en': {
			...
			'troupsize': 'Ilo¶æ jednostek',
			'troupsizedesc': 'Model wojska w tej grupie wed³óg którego bêdzie przebiega³a rekrutacja.',
			'openend': 'Do oporu:',
			'openenddesc': 'po wyprodykowaniu zleconych bêdzie produkcja do wyczerpania miejsca w zagrodzie.',
			'farmfree': 'Pozostawiæ miejsca w zagrodzie:',
			'farmfreedesc': 'Ile ma zostaæ wolnego miejsca w zagrodzie (np. 100 na Ulunga ;).',
			'resfree': 'Pozostawiæ surowców:',
			'resfreedesc': 'Ile ma zostaæ surowców.',
			'save': 'Zapisz',
			'fill': 'Wprowad¼',
			'recruit': 'Rekrutuj',
			'running': 'czekaj...',
